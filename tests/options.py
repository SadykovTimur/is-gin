def pytest_addoption(parser):
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='ServiceMonitor2', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='RF4b*o#', help='Password')
